const StructsExercicios = () => {
    return (
        <div>
            <h2><strong>Exercícios com suas Respectivas Soluções</strong></h2>
            ...
            <h3><strong>Aula 1: Introdução às Structs</strong></h3>
  ...
  int main() {
      ...
      return 0;
            ...
            <h3><strong>Aula 2: Arrays de Structs</strong></h3>
  ...
  int main() {
      ...
      return 0;
            ...
            <h3><strong>Aula 3: Structs como Parâmetros de Funções</strong></h3>
  ...
  int main() {
      ...
      return 0;
            ...
            <h3><strong>Aula 4: Revisão e Desafios</strong></h3>
