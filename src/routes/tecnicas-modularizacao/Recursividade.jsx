  ...
  return (
    <div>
      ...
      <iframe
        width="1200"
        height="700"
        src="https://www.youtube.com/embed/8FeuNLzMrrk?si=VzAkPKgT7gK4IH10"
      ...
      <ul>
        <li>
          <strong>Definição:</strong> Recursividade é uma técnica de programação
          onde uma função chama a si mesma diretamente ou indiretamente.
        </li>
        <li>
          <strong>Importância:</strong> Simplifica a resolução de problemas
          complexos, dividindo-os em subproblemas menores e mais manejáveis.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Divisão e Conquista:</strong> Algoritmos como Quick Sort e
          Merge Sort.
        </li>
        <li>
          <strong>Problemas Combinatórios:</strong> Permutações, combinações,
          torres de Hanói.
        </li>
        <li>
          <strong>Árvores e Grafos:</strong> Percursos em árvores (preorder,
          inorder, postorder) e busca em grafos (DFS).
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Caso Base:</strong> Condição que termina a recursão.
        </li>
        <li>
          <strong>Caso Recursivo:</strong> Parte da função que chama a si mesma
...
int main() {
    ...
    return 0;
      ...
      <h5>
        <strong>Com Recursividade</strong>
      </h5>
      <pre>
        <code>{`
#include <stdio.h>
...
int main() {
    ...
    return 0;
      ...
      <ol>
        <li>
          <code>imprimirOi(5)</code> chama <code>imprimirOi(4)</code>.
        </li>
        <li>
          <code>imprimirOi(4)</code> chama <code>imprimirOi(3)</code>.
        </li>
        <li>
          <code>imprimirOi(3)</code> chama <code>imprimirOi(2).</code>
        </li>
        <li>
          <code>imprimirOi(2)</code> chama <code>imprimirOi(1)</code>.
        </li>
        <li>
          <code>imprimirOi(1)</code> chama <code>imprimirOi(0)</code>.
        </li>
        <li>
...
5 - oi
      ...
      <ul>
        ...
        <ul>
          <li>
            <strong>Simplicidade:</strong> Código mais limpo e fácil de entender
            para problemas que se dividem naturalmente.
          </li>
          <li>
            <strong>Natural para Estruturas Recursivas:</strong> Árvores e
            grafos.
          </li>
        </ul>
        <li>Desvantagens:</li>
        <ul>
          <li>
            <strong>Consumo de Memória:</strong> Cada chamada recursiva consome
            memória da pilha.
          </li>
          <li>
            <strong>Desempenho:</strong> Pode ser menos eficiente em alguns
            casos devido ao overhead das chamadas de função.
          </li>
        </ul>
      </ul>
      ...
      <p>
        <strong>Cálculo do Fatorial de um número usando Recursividade</strong>
      </p>
      <p>
        Objetivo: Implementar uma função recursiva para calcular o fatorial de
        um número.
      </p>
      <p>
        Descrição: O fatorial de um número inteiro positivo n representado como
        n! é o produto de todos os números inteiros positivos de 1 até n. Por
        definição, o fatorial de 0 é 1 (0! = 1). O fatorial de n pode ser
      ...
      <p>
        Sua tarefa é escrever uma função recursiva que receba um número inteiro
        n e retorne o fatorial desse número.
      </p>
    </div>
  );
};
